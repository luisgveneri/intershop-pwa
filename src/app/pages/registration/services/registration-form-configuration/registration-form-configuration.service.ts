  ...
  private getPersonalInfoConfig(): FormlyFieldConfig[] {
    return [
      ...
      },
      {
        ...
        fieldGroup: this.reusableFormlyFieldConfigurationsService.getConfigurationGroup('personalInfo'),
      },
    ];
  }
  ...
  private getCompanyInfoConfig(): FormlyFieldConfig[] {
    return [
      ...
      },
      {
        ...
        fieldGroup: this.reusableFormlyFieldConfigurationsService.getConfigurationGroup('companyInfo'),
      },
    ];
  }
}
